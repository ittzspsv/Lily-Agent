...
class Agent(AgentBase):
    ...
    def format_tools(self, tools: Optional[List[Tool]] = None) -> List[dict]:
        tools_to_format = tools if tools is not None else self.tools
        return self.formatter.format_many(tools_to_format) if tools_to_format else []
    ...
    async def execute_tools(
        ...
        **kwargs
        ...
        return await self.tool_executor.execute(tool_calls, **kwargs)
